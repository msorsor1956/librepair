      ...
      >
        <div className="glass rounded-2xl p-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-center" style={{ color: "var(--color-muted)" }}>Join LIBrepair — get your car serviced today</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--color-silver)" }}>Full Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="text-sm text-center mt-4" style={{ color: "var(--color-muted)" }}>
            ...
            <Link to="/sign-in">
              <span className="font-semibold hover:underline" style={{ color: "var(--color-red)" }}>Sign in</span>
            </Link>
          </p>
        </div>
      </motion.div>
